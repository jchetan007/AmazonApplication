...
//#region sellerId Prop
        @gridColumn({visible: true, columnIndex:6, allowSorting: true, headerKey: 'sellerId', keyColumn: false})
        sellerId : number;
//#endregion sellerId Prop


//#region cartItemId Prop
        @gridColumn({visible: true, columnIndex:7, allowSorting: true, headerKey: 'cartItemId', keyColumn: false})
        cartItemId : number;
...
//#region cartQuantity Prop
        @gridColumn({visible: true, columnIndex:6, allowSorting: true, headerKey: 'cartQuantity', keyColumn: false})
        cartQuantity : number;
